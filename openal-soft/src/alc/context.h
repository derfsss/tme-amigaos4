...
private:
     ...
     * On AmigaOS4, thread_local is unavailable (GCC 11.5). Use static
     * instead — ALC_EXT_thread_local_context won't provide per-thread
     * contexts, but this is acceptable for our use case (single audio
     * context in Lords of Midnight).
     */
#if defined(__amigaos4__)
    static inline ALCcontext *sLocalContext{};
#else
